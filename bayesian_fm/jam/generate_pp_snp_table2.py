...
ap.add_argument('--proces',required=True,type=str,help="Table with SNPs processed")
ap.add_argument('--proces_id',required=True,type=int,help='Column with IDs processed in --proces')
