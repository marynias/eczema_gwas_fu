...
#' assoc_plot2a
#'
#' assoc_plot2a plots a scatter graph of associations (e.g. log10 p-values)
...
#' @export
assoc_plot2a <- function(data, corr=NULL, corr.top=NULL, ylab=NULL, title=NULL, subtitle=NULL, type="log10p", x.min=NULL, x.max=NULL, top.marker=NULL, legend=TRUE, my_locus_lab=NULL, my_locus_pos=NULL){
  ...
  marker.plot <- plot_assoc2a(data, corr, corr.top, x.min, x.max, top.marker, ylab, type, my_locus_lab, my_locus_pos)
  
  # Combined plot
  legend <- FALSE
  combined.plot <- plot_assoc_combined2a(recombination.plot, gene.plot, marker.plot, title, subtitle, ngenes, legend)
...
#' @author James R Staley <james.staley@bristol.ac.uk>
#' @export
plot_assoc_combined2a <- function(recombination.plot, gene.plot, marker.plot, title=NULL, subtitle=NULL, ngenes, r2_legend=FALSE){
...
#' plot_assoc2a
#'
#' plot_assoc2a plots a scatter graph of associations (e.g. log10 p-values) 
...
#' @author James R Staley <james.staley@bristol.ac.uk>
#' @export
plot_assoc2a <- function(data, corr=NULL, corr.top=NULL, x.min, x.max, top.marker=NULL, ylab, type="log10p", my_locus_lab=NULL, my_locus_pos=NULL){
  ...
  ylim <- max(data$stats)
  #Define index SNP.
  my_locus <- data.frame(marker=my_locus_lab, chr=lead_marker$chr, pos=my_locus_pos, stats=ylim)
