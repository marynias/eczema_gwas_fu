...
#' plot_assoc4
#'
#' plot_assoc4 plots a scatter graph of associations (e.g. log10 p-values) 
...
#' @export
plot_assoc4 <- function(data, corr=NULL, corr.top=NULL, x.min, x.max, top.marker=NULL, ylab, type="log10p"){
...
#' plot_assoc_combined4
#'
#' plot_assoc_combined4 combines the recombination plot, gene bar and association scatter graph  
...
#' @author James R Staley <james.staley@bristol.ac.uk>
#' @export
plot_assoc_combined4 <- function(recombination.plot, gene.plot, marker.plot, title=NULL, subtitle=NULL, ngenes, r2_legend=TRUE){
...
#' assoc_plot4
#'
#' assoc_plot4 plots a scatter graph of associations (e.g. log10 p-values)
...
#' @author James R Staley <james.staley@bristol.ac.uk>
#' @export
assoc_plot4 <- function(data, corr=NULL, corr.top=NULL, ylab=NULL, title=NULL, subtitle=NULL, type="log10p", x.min=NULL, x.max=NULL, top.marker=NULL, legend=TRUE){
  ...
  marker.plot <- plot_assoc4(data, corr, corr.top, x.min, x.max, top.marker, ylab, type)
  
  # Combined plot
  combined.plot <- plot_assoc_combined4(recombination.plot, gene.plot, marker.plot, title, subtitle, ngenes, legend)
