...
#' assoc_plot2
#'
#' assoc_plot2 plots a scatter graph of associations (e.g. log10 p-values)
...
#' @export
assoc_plot2 <- function(data, corr=NULL, corr.top=NULL, ylab=NULL, title=NULL, subtitle=NULL, type="log10p", x.min=NULL, x.max=NULL, top.marker=NULL, legend=TRUE){
  ...
  marker.plot <- plot_assoc2(data, corr, corr.top, x.min, x.max, top.marker, ylab, type)
  
  # Combined plot
  legend <- FALSE
  combined.plot <- plot_assoc_combined2(recombination.plot, gene.plot, marker.plot, title, subtitle, ngenes, legend)
...
#' @author James R Staley <james.staley@bristol.ac.uk>
#' @export
plot_assoc_combined2 <- function(recombination.plot, gene.plot, marker.plot, title=NULL, subtitle=NULL, ngenes, r2_legend=FALSE){
...
#' plot_assoc2
#'
#' plot_assoc2 plots a scatter graph of associations (e.g. log10 p-values) 
...
#' @author James R Staley <james.staley@bristol.ac.uk>
#' @export
plot_assoc2 <- function(data, corr=NULL, corr.top=NULL, x.min, x.max, top.marker=NULL, ylab, type="log10p"){
